...
Vue.component("purple_feature_grid_component_1721893217", {
    template: `
    <div class="flex">
        <!-- Sidebar -->
        <div class="w-64 bg-gray-800 h-screen p-5">
            <nav>
                <ul class="space-y-2">
                    <li><a href="#" class="text-white hover:text-gray-300 flex items-center"><i class='bx bx-home mr-2'></i> Home</a></li>
                    <li><a href="#" class="text-white hover:text-gray-300 flex items-center"><i class='bx bx-info-circle mr-2'></i> About</a></li>
                    <li><a href="#" class="text-white hover:text-gray-300 flex items-center"><i class='bx bx-envelope mr-2'></i> Contact</a></li>
                </ul>
            </nav>
        </div>
        ...
        <div class="flex-1">
            ...
            <div id="features-grid" class="grid md:grid-cols-3 gap-8 md:gap-12 bg-white p-5">
                ...
                <div id="feature-1">
                    ...
                    <div class="flex" id="feature-1-description-container"><p id="feature-1-description" class="flex-1 text-sm" :class="textPrimaryStyle">Stay ahead of the curve with our cutting-edge Ethereum transaction analysis tool. Monitor new transactions as they occur on the blockchain in real-time, giving you the competitive edge you need.</p></div>
                </div>
                <!-- Feature -->
                <div id="feature-2">
                    ...
                    <div class="flex" id="feature-2-description-container"><p id="feature-2-description" class="flex-1 text-sm" :class="textPrimaryStyle">Gain valuable insights into transaction patterns, trends, and anomalies with our powerful analytics engine. Unlock a deeper understanding of the Ethereum network's behavior and make data-driven decisions.</p></div>
                </div>
                <!-- Feature -->
                <div id="feature-3">
                    ...
                    <div class="flex" id="feature-3-description-container"><p id="feature-3-description" class="flex-1 text-sm" :class="textPrimaryStyle">Never miss a critical transaction with our highly configurable alert system. Set custom triggers based on transaction attributes, values, or patterns, ensuring you're always in the loop.</p></div>
                </div>
                <!-- Feature -->
                <div id="feature-4">
                    ...
                    <div class="flex" id="feature-4-description-container"><p id="feature-4-description" class="flex-1 text-sm" :class="textPrimaryStyle">Our transaction analysis app seamlessly integrates with your existing Ethereum infrastructure, providing a unified and streamlined experience for monitoring and analysis.</p></div>
                </div>
                <!-- Feature -->
                <div id="feature-5">
                    ...
                    <div class="flex" id="feature-5-description-container"><p id="feature-5-description" class="flex-1 text-sm" :class="textPrimaryStyle">Built with security and reliability in mind, our app ensures your transaction data remains safe and accessible at all times, giving you peace of mind in a constantly evolving blockchain landscape.</p></div>
                </div>
                <!-- Feature -->
                <div id="feature-6">
